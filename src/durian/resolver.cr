class Durian::Resolver
  ...
  def self.get_tcp_socket!(host : String, port : Int32, resolver : Resolver, connect_timeout : Int::Primitive | Float::Primitive | Nil = nil) : ::TCPSocket
    fetch_list = getaddrinfo_all host, port, resolver
    raise Socket::Error.new "DNS query result IP is empty, or DNS query failed" if fetch_list.empty?
  ...
  def self.get_udp_socket!(host : String, port : Int32, resolver : Resolver, connect_timeout : Int::Primitive | Float::Primitive | Nil = nil) : ::UDPSocket
    fetch_list = getaddrinfo_all host, port, resolver
